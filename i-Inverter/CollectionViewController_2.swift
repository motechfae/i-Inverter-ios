//
//  CollectionViewController_2.swift
//  i-Inverter
//
...
class CollectionViewController_2: UICollectionViewController, UICollectionViewDelegateFlowLayout, UISearchBarDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        print("prepare(CVC2): " + g_sSiteNo + "/" + g_sSite_Name + "/" + g_sZoneNo)
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // Configure the cell
        let imgView = cell.viewWithTag(602) as? UIImageView
        ...
        let titleLabel = cell.viewWithTag(202) as? UILabel
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
       ...
       if (kind == UICollectionView.elementKindSectionHeader) {
           let headerView:UICollectionReusableView =  collectionView.dequeueReusableSupplementaryView(ofKind: UICollectionView.elementKindSectionHeader, withReuseIdentifier: "SearchBar2", for: indexPath)
